...
exports.getUser = (req, res, next) => {
  logger.log({
    level: "info",
    date: new Date(),
    message: "Méthode getUser" + req.params,
  });
...
exports.updateUser = (req, res, next) => {
  logger.log({
    level: "info",
    date: new Date(),
    message: "Méthode updateUser " + req.params.id + req.body,
  });
